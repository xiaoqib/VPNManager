...
- (void)setUp{
    self.imgView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 7, 34, 34)];
    [self.contentView addSubview:self.imgView];
    
    self.txtLabel = [[UILabel alloc] initWithFrame:CGRectMake(54, 7, 146, 34)];
    self.txtLabel.numberOfLines = 0;
    self.txtLabel.textColor = [UIColor whiteColor];
    self.txtLabel.font = [UIFont systemFontOfSize:16.f];
