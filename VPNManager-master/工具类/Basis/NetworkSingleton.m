...
- (void)POST:(NSString *)URLString parameters:(NSDictionary *)parameters withJWT:(NSString *)Authorization success:(void (^)(id))success failure:(void (^)(NSError *))failure{
    ...
    NSString *code = [NSString stringWithFormat:@"Bearer %@",Authorization];
    [manager.requestSerializer setValue:code forHTTPHeaderField:@"Authorization"];
